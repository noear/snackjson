/*
 * Copyright 2005-2026 noear.org and authors
 *
 ...
 * @since 4.0
 */
public class DurationMapper implements SchemaMapper<Duration> {
    @Override
    public ONode mapSchema(TypeEggg typeEggg, ONode target) {
        return target.set(SchemaKeyword.TYPE, SchemaType.STRING)
                .set(SchemaKeyword.DESCRIPTION, "ISO-8601 duration format (e.g., PT15M, PT2H30M, P3D)");
    }
}
